 ...
 */
public class RoundRobinByWeightLoadBalanceTest {
    /**
    ...
    public RoundRobinByWeightLoadBalanceTest(Map<Invoker, Integer> invokersWeight) {
    ...
    public static void main(String[] args) {
        ...
        Integer aWeight = Integer.valueOf(ResourceBundle.getBundle("agent.properties").getString("small.provider").trim());
        Integer bWeight = Integer.valueOf(ResourceBundle.getBundle("agent.properties").getString("medium.provider").trim());
        Integer cWeight = Integer.valueOf(ResourceBundle.getBundle("agent.properties").getString("large.provider").trim());
        ...
        Integer times = 7;
        RoundRobinByWeightLoadBalanceTest roundRobin = new RoundRobinByWeightLoadBalanceTest(invokersWeight);
